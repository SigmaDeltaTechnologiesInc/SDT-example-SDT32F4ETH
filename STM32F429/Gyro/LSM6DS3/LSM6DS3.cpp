...
//=================================
//****************************************************************************//
LSM6DS3Core::LSM6DS3Core( uint8_t busType, SPI* spi, DigitalOut* cs) 
    : commInterface(SPI_MODE), 
      I2CAddress(0x6B), 
    //   spi_(SPI_MOSI,SPI_MISO,SPI_SCK), 
      spi_(spi), 
      ...
      cs_(cs)
{
    ...
    if( commInterface == SPI_MODE ) {
        // chipSelectPin = inputArg;   // Not used
    }
}
...
//
//****************************************************************************//
LSM6DS3::LSM6DS3( uint8_t busType, SPI* spi, DigitalOut* cs ) : LSM6DS3Core( busType, spi, cs )
{
