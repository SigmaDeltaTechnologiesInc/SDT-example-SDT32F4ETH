...
#define MBED_CONF_ESP8266_PROVIDE_DEFAULT                                     1                                                                                                // set by application[NUCLEO_F429ZI]
#define MBED_CONF_ESP8266_RX                                                  PA_10                                                                                            // set by application[NUCLEO_F429ZI]
...
#define MBED_CONF_ESP8266_TX                                                  PA_9                                                                                             // set by application[NUCLEO_F429ZI]
...
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       WIFI                                                                                             // set by application[NUCLEO_F429ZI]
#define MBED_CONF_TARGET_STDIO_UART_RX                                        PD_6                                                                                             // set by application[NUCLEO_F429ZI]
#define MBED_CONF_TARGET_STDIO_UART_TX                                        PD_5                                                                                             // set by application[NUCLEO_F429ZI]
